...
export default function TrustBadge() {
  return (
    <div className="fixed bottom-20 left-4 z-40 animate-fade-in-up hidden md:block">
      <div className="bg-white rounded-lg shadow-xl p-3 flex items-center gap-3 border border-gray-100 transition-transform hover:scale-105 cursor-pointer">
